...
const char * const BITCOIN_CONF_FILENAME = "honeycomb.conf";
const char * const BITCOIN_PID_FILENAME = "honeycomb.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Honeycomb";
#else
    // Unix
