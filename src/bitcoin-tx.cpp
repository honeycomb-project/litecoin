...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s honeycomb-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  honeycomb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded honeycomb transaction") + "\n" +
              "  honeycomb-tx [options] -create [commands]   " + _("Create hex-encoded honeycomb transaction") + "\n" +
              "\n";
